...
public class StandardDeck implements Deck, Iterable<Card>{
    ...
    public static void main(String... args) {
        ...
        //default methods
        myDeck.sort(
                Comparator.comparing(Card::getRank).reversed().thenComparing(Card::getSuit)
        );
        myDeck.forEach(card -> System.out.println(card.toString()));
    }
}
